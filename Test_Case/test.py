...
def data_extaction():
    ...
    data_input = open("/home/alexander/Desktop/WORK/AdvocadeOfCode_2020/Test_Case/test.txt", "r")
...
def detect_valid_pass(potential_valid):
    ...
    for num in range(len(potential_valid)):
        ...
        for num2 in range(len(potential_valid[num])):
            ...
            if first_part == "ecl":
                if second_part == "amb" or second_part == "blu" or second_part == "brn" or second_part == "gry" or second_part == "hzl" or second_part == "oth":
                    ecl = True
            ...
            if first_part == "hcl" and len(second_part) == 7 and second_part[0] == "#":
                hcl = True
